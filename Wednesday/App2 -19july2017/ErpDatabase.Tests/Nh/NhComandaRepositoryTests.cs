...
namespace ErpDatabase.Tests
{
    ...
    public class NhComandaRepositoryTests : NhAbstractTest<Comanda>
    {
        ...
        {
            return "select 1"; // "delete LinieComanda from LinieComanda lc inner join Comanda c on c.ComandaId = lc.ComandaId where ClientId = 1; delete Comanda where ClientId = 1";
        }
