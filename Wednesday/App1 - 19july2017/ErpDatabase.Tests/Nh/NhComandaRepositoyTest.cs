...
{
    [TestClass]
    public class ComandaRepositoryTests : NhAbstractTest<Comanda>
    {
        ...
        protected override Comanda CreateObject()
        {
            ...
            comanda.Linii.Add(new LinieComanda { Cantitate = 999, Comanda = comanda, Produs = new Produs { Id = 1 } });

            comanda.Linii.Add(new LinieComanda { Cantitate = 1000, Comanda = comanda, Produs = new Produs { Id = 1 } });
